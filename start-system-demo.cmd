@echo off
start /min cmd.exe @cmd /c "cd .\Backend-SSO && .\mvnw clean install -DskipTests -q && java -jar .\target\Backend-SSO.jar"
start /min cmd.exe @cmd /c "cd .\Backend-App1 && .\mvnw clean install -DskipTests -q && java -jar .\target\Backend-App1.jar"
